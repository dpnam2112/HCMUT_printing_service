"""
Django settings for hcmut_printing_service project.
...
SECRET_KEY = 'django-insecure--&ogge+s52)h8r9a5rcn1mjjjbww$)@+0v@)cki#w#-_h@q6zv'
...
WSGI_APPLICATION = 'hcmut_printing_service.wsgi.application'
