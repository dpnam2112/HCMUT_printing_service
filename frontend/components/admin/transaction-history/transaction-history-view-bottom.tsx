...
type TransactionHistoryViewBottomProps = {
  rowsNum: number;
...
const TransactionHistoryViewBottom: FC<TransactionHistoryViewBottomProps> = ({
  rowsNum,
  rowsNumPerPage,
  currentPage,
  setRowsNumPerPage,
    ...
    <div className="flex items-center justify-end">
      <div className="flex items-center gap-4">
        <div className="flex items-center gap-2">
          <span className="font-medium text-sm text">Số dòng mỗi trang</span>
          <DropdownMenu.Root>
            <DropdownMenu.Trigger className="w-[50px]">
...
export default TransactionHistoryViewBottom;
