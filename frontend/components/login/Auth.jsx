        ...
        <div>   
            ...
            >
                ...
                <fieldset className="mb-[20px] w-full flex flex-col justify-start">
                    <label className="text-[15px] leading-none mb-2.5 text-violet12 block" htmlFor="username">
                ...
                <fieldset className="mb-[20px] w-full flex flex-col justify-start">
                    <label className="text-[16px] leading-none mb-2.5 text-violet12 block" htmlFor="password">
                    Mật khẩu
                    </label>
                    <input
                    className="grow shrink-0 rounded px-2.5 text-[16px] leading-none text-violet11 shadow-[0_0_0_1px] shadow-violet7 h-[40px] focus:shadow-[0_0_0_2px] focus:shadow-violet8 outline-none"
                ...
                <Checkbox.Root
                    className="flex h-[20px] w-[20px] items-center justify-center rounded-[4px] bg-white bg-gray-100 outline-none shadow-[0_0_0_1.5px_black] focus:shadow-[0_0_0_2px_black]"
                    id="c1"
                >
                ...
                <label className="pl-[10px] text-[15px] leading-none text-gray-700" htmlFor="c1">
                    Lưu thông tin đăng nhập
                </label>
                </div>    
                <p id="helper-checkbox-text" className="text-xs font-normal leading-5 text-gray-500 dark:text-gray-400">Chúng tôi cam kết không thu thập thông tin cá nhân của bạn. Vui lòng đọc <a href="#" className="font-medium text-blue-500 hover:underline dark:text-blue-400">Chính sách bảo mật</a> của chúng tôi.</p>
                ...
                <div className="font-bold text-[15px] text-center text-blue-800 mt-3 leading-5 items-center text-gray-500 dark:text-gray-400 hover:underline hover:underline-offset-2" htmlFor="c1">                  
                <a href="http://localhost:3000/forgotpassword" className="text-blue-600">Quên mật khẩu?</a>
                </div> 
                </Tabs.Content>
                <Tabs.Content
                className="grow p-5 bg-white rounded-b-md outline-none"
                ...
                <fieldset className="mb-[20px] w-full flex flex-col justify-start">
                    ...
                    placeholder="•••••••••" required
                    />
                </fieldset> <label className="font-semibold text-[15px] text-gray-500 dark:text-gray-400" htmlFor="c1">
                   
                    Khi bạn nhấn vào nút Đăng kí, Bạn đồng ý với <a href="http://localhost:3000/terms-of-use" class="font-bold text-blue-600/[.9] dark:text-blue-500/[.9] hover:underline">điều khoản và điều kiện sử dụng dịch vụ.</a>
                    </label>             
                <div className="flex justify-end mt-5">
                    <button className="inline-flex items-center justify-center w-[400px] rounded px-[15px] text-[15px] leading-none font-medium h-[40px] bg-black text-white hover:bg-green5 focus:shadow-[0_0_0_2px] focus:shadow-green7 outline-none cursor-default">
                    Đăng kí
            ...
            <div className="w-full max-h-full  flex flex-col items-center justify-start text-center">
                ...
                Hỗ trợ kĩ thuật: <span className="underline underline-offset-2">support@sps.hcmut.edu.vn</span>
                </div>
